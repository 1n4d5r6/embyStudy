...
static void BS3641_Delay(void){
	for(uint16_t i = 10 ; i > 0; i--);
}
static void BS3641_StopAll(void){
...
static void BS3641_ShowEach(uint8_t index , uint8_t res){
...
void BS3641_Show4num(uint16_t res){
	uint16_t dat = res;
