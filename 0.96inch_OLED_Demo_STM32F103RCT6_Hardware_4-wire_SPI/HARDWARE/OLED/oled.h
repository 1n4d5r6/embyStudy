...
//-----------------OLED端口定义----------------
#define OLED_CS   GPIO_Pin_7   //片选信号           PB11
#define OLED_DC   GPIO_Pin_6   //数据/命令控制信号  PB10
#define OLED_RST  GPIO_Pin_12   //复位信号           PB12

//-----------------OLED端口操作定义---------------- 
#define OLED_CS_Clr()  GPIO_ResetBits(GPIOC,OLED_CS)
#define OLED_CS_Set()  GPIO_SetBits(GPIOC,OLED_CS)

#define OLED_DC_Clr()  GPIO_ResetBits(GPIOC,OLED_DC)
#define OLED_DC_Set()  GPIO_SetBits(GPIOC,OLED_DC)
