...
void W25Q64_SPI_Init(void){
	W25Q64_SPI_CLK_CMD(W25Q64_SPI_CLK,ENABLE);
	...
	W25Q64_GPIO_CLK_CMD(W25Q64_GPIO_CLK | W25Q64_GPIO_NSS_CLK,ENABLE);
	GPIO_InitTypeDef gpio_init;
	gpio_init.GPIO_Mode = GPIO_Mode_Out_PP;
	gpio_init.GPIO_Speed = GPIO_Speed_50MHz;
	gpio_init.GPIO_Pin = W25Q64_GPIO_NSS_PIN;
	GPIO_Init(W25Q64_GPIO_NSS_PORT,&gpio_init);
	
	gpio_init.GPIO_Pin = W25Q64_GPIO_CLK_PIN;
	gpio_init.GPIO_Mode = GPIO_Mode_AF_PP;
	GPIO_Init(GPIOA,&gpio_init);
	
	gpio_init.GPIO_Pin = W25Q64_GPIO_MISO_PIN;
	GPIO_Init(GPIOA,&gpio_init);
	
	gpio_init.GPIO_Pin = W25Q64_GPIO_MOSI_PIN;
	GPIO_Init(GPIOA,&gpio_init);
	
	GPIO_SetBits(W25Q64_GPIO_NSS_PORT,W25Q64_GPIO_NSS_PIN);
}

uint8_t W25Q64_SendByte(uint8_t byte){
	GPIO_ResetBits(W25Q64_GPIO_NSS_PORT,W25Q64_GPIO_NSS_PIN);
